...
* 중지단어란 큰 의미가 없는 단어들을 말한다. 예를 들어 그러나, 그리고, 따라서와 같이 검색에 있어서 큰 식별 단어가 되지 못하는 단어들이다.
...
+-------------------------------------------------------------
```
Filter 평균 소요 시간 : 0.08849초
Full-text index search 평균 소요 시간 0.3593초
